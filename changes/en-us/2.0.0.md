### 2.0.1
 ...
 [source](https://github.com/seata/seata/archive/v2.0.1.zip) |	
 [binary](https://github.com/seata/seata/releases/download/v2.0.1/seata-server-2.0.1.zip) 	
